module.exports.config = {
  ...
  description: "Random Anime Videos From Sabbir API",
...
module.exports.run = async function ({ api, event }) {
  ...
  const API_LIST_URL = "https://raw.githubusercontent.com/Sabbir-Sabbir/Sabbir-API/refs/heads/main/Sabbir-API.json";
  try {
    ...
    writer.on("finish", () => {
      api.sendMessage(
        {
          body: "🎬 Sabbir Anemi Random Video",
