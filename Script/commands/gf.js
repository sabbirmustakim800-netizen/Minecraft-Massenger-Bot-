module.exports.config = {
  ...
  version: "1.0.1",
  hasPermssion: 0,
  credits: "Sabbir Sabbir", //don't change credit✔️
...
module.exports.run = async function ({ event, api }) {
  ...
  try {
    const apiList = await axios.get(
      "https://raw.githubusercontent.com/Sabbir-Sabbir/Sabbir-API/main/Sabbir-API.json"
    );
    ...
    return api.sendMessage(
      "GF API Error | Sabbir-API unreachable",
      threadID,
      messageID
    );
  }
