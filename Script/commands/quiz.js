...
const CONFIG_URL = "https://raw.githubusercontent.com/Sabbir-Sabbir/Sabbir-API/refs/heads/main/Sabbir-API.json";
...
module.exports.run = async function ({ api, event }) {
  ...
  try {
    ...
    if (!quizAPI) return api.sendMessage("Quiz API error call boss Sabbir✔️", threadID, messageID);
    ...
    api.sendMessage("Quiz API error call boss Sabbir✔", threadID, messageID);
  }
};
