...
module.exports = {
  config: {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "Sabbir Sabbir", //don't change credit
...
async function processImage(api, threadID, messageID, messageReply) {
  ...
  try {
    const configUrl =
      "https://raw.githubusercontent.com/Sabbir-Sabbir/Sabbir-API/refs/heads/main/Sabbir-API.json";
    ...
    api.sendMessage("❌ API Error! Boss Sabbir ke message din!", threadID, messageID);
  }
}
